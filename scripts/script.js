...
// making a small sphere as a market for the points and put it on the actuall locations
  ...
  data.forEach(function(coord){
    ...
    sorted_streets.forEach(function(e){
			...
			// var vector_array = [];
			//
			// // componentsConfig.components_map.get(current_component).forEach(function(each_component){
			// var pointMeasuredVect = new THREE.Vector3(e.x, e.y, 2)
			// vector_array.push(pointMeasuredVect)
			// lineGeometry.vertices.push(pointMeasuredVect);
...
function animateScene(){
	...
	requestStream.frame_counter = requestStream.frame_counter + 1;
