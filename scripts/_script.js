...
(function() {
  ...
  window.onload = function() {
    var animate, animateCameraFov, animateX, animateY, axes, camera, controls, cube, cube2, cube3, cubeGeo2, cubeGeo3, cubeGeometry, cubeMaterial, data, geometry, gui, line, loader, material, material2, material3, opts, params, plane, planeGeometry, planeMaterial, renderer, scene, spotLight, viz;
    ...
    loader.load('ph1.png', (function(image) {
      var canvas, context;
